...
!(function (t, e) {
        ...
        if ("click" === e)
          N.on(
            ...
            (t) => {
              ...
              (e._activeTrigger[cs] = !(e._isShown() && e._activeTrigger[cs])),
                e.toggle();
            }
          );
        else if ("manual" !== e) {
  ...
  const ps = ".popover-header",
    ...
    _s = { ...fs.DefaultType, content: "(null|string|element|function)" };
  class bs extends fs {
    static get Default() {
      return gs;
    }
  ...
  class Ls extends W {
    ...
    _maybeEnableSmoothScroll() {
      this._config.smoothScroll &&
        (N.off(this._config.target, ws),
        N.on(this._config.target, ws, Ts, (t) => {
    ...
    _process(t) {
      this._activeTarget !== t &&
        ...
        N.trigger(this._element, ys, { relatedTarget: t }));
    }
    _activateParents(t) {
      if (t.classList.contains("dropdown-item"))
        z.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(Es);
      else
        for (const e of z.parents(t, ".nav, .list-group"))
          for (const t of z.prev(e, Os)) t.classList.add(Es);
    }
    _clearActiveClass(t) {
  ...
  class Js extends W {
    constructor(t) {
      super(t),
        ...
        this._parent &&
          ...
          N.on(this._element, js, (t) => this._keydown(t)));
    }
    static get NAME() {
      return "tab";
    }
    show() {
      ...
      const e = this._getActiveElem(),
        i = e ? N.trigger(e, Ds, { relatedTarget: t }) : null;
      N.trigger(t, Is, { relatedTarget: e }).defaultPrevented ||
          ...
          () => {
            "tab" === t.getAttribute("role")
              ? (t.removeAttribute("tabindex"),
                ...
                N.trigger(t, Ns, { relatedTarget: e }))
              : t.classList.add(Ks);
          },
          t,
          t.classList.contains(Vs)
        ));
    }
    _deactivate(t, e) {
      t &&
    ...
    _keydown(t) {
      ...
      i && (i.focus({ preventScroll: !0 }), Js.getOrCreateInstance(i).show());
    }
    _getChildren() {
  ...
  const Zs = ".bs.toast",
    ...
    fo = { animation: !0, autohide: !0, delay: 5e3 };
  class po extends W {
    constructor(t, e) {
      super(t, e),
        (this._timeout = null),
    ...
    show() {
      N.trigger(this._element, ro).defaultPrevented ||
        (this._clearTimeout(),
        this._config.animation && this._element.classList.add("fade"),
        this._element.classList.remove(lo),
        d(this._element),
        this._element.classList.add(co, ho),
        this._queueCallback(
          () => {
            this._element.classList.remove(ho),
              N.trigger(this._element, ao),
    ...
    hide() {
      this.isShown() &&
        (N.trigger(this._element, so).defaultPrevented ||
          (this._element.classList.add(ho),
          this._queueCallback(
            () => {
              this._element.classList.add(lo),
                this._element.classList.remove(ho, co),
                N.trigger(this._element, oo);
            },
            this._element,
            this._config.animation
          )));
    ...
    _setListeners() {
      N.on(this._element, to, (t) => this._onInteraction(t, !0)),
        N.on(this._element, eo, (t) => this._onInteraction(t, !1)),
        N.on(this._element, io, (t) => this._onInteraction(t, !0)),
        N.on(this._element, no, (t) => this._onInteraction(t, !1));
    }
    _clearTimeout() {
