...
this.driver.js = (function (F) {
  ...
  function j(e) {
    if (!e) return;
    const o = e.getBoundingClientRect(),
      t = { x: o.x, y: o.y, width: o.width, height: o.height };
  ...
  function xe(e, o) {
    ...
    !f && a && a(r ? void 0 : n, d, { config: p, state: c, driver: S() }),
      g && g(w ? void 0 : e, o, { config: p, state: c, driver: S() });
    const u = !f && v;
    let h = !1;
    _e(),
      k("previousStep", d),
    ...
    const m = () => {
      ...
      const x = Date.now() - i,
        T = 400 - x <= 400 / 2;
      o.popover && T && !h && u && (ee(e, o), (h = !0)),
        s("animate") && x < 400
          ? fe(x, 400, n, e)
          : (j(e),
            y && y(w ? void 0 : e, o, { config: s(), state: l(), driver: S() }),
    ...
    k("__transitionCallback", m),
      ...
      ((C = o.disableActiveInteraction) != null
        ? C
  ...
  function J(e) {
    ...
    ((t = s("allowKeyboardControl")) == null || t) &&
      (e.key === "Escape"
        ...
        : e.key === "ArrowRight"
        ? E("arrowRightPress")
        : e.key === "ArrowLeft" && E("arrowLeftPress"));
  }
  function U(e, o, t) {
    const i = (n, f) => {
      const w = n.target;
  ...
  function ee(e, o) {
    ...
    const {
      ...
      disableButtons: f,
      showProgress: w,
      nextBtnText: r = s("nextBtnText") || "Próximo &rarr;",
    ...
    (t.nextButton.innerHTML = r),
      ...
      i
        ? ((t.title.innerHTML = i), (t.title.style.display = "block"))
    ...
    const m =
      ((x = o.popover) == null ? void 0 : x.popoverClass) ||
      s("popoverClass") ||
      "";
    (u.className = `driver-popover ${m}`.trim()),
      U(
        ...
        (T) => {
          ...
          const L = T.target,
            $ =
              ((W = o.popover) == null ? void 0 : W.onNextClick) ||
              s("onNextClick"),
            B =
              ((I = o.popover) == null ? void 0 : I.onPrevClick) ||
              s("onPrevClick"),
            R =
              ((M = o.popover) == null ? void 0 : M.onCloseClick) ||
              s("onCloseClick");
          if (L.closest(".driver-popover-next-btn"))
            return $
              ? $(e, o, { config: s(), state: l(), driver: S() })
              : E("nextClick");
          if (L.closest(".driver-popover-prev-btn"))
            return B
              ? B(e, o, { config: s(), state: l(), driver: S() })
              : E("prevClick");
          if (L.closest(".driver-popover-close-btn"))
            return R
              ? R(e, o, { config: s(), state: l(), driver: S() })
              : E("closeClick");
        },
        (T) =>
          !(t != null && t.description.contains(T)) &&
          !(t != null && t.title.contains(T)) &&
          typeof T.className == "string" &&
          T.className.includes("driver-popover")
      ),
      k("popover", t);
    const b =
      ((P = o.popover) == null ? void 0 : P.onPopoverRender) ||
      s("onPopoverRender");
    b && b(t, { config: s(), state: l(), driver: S() }), ne(e, o), Y(u);
  ...
  function oe(e, o) {
    ...
    return e === "start"
      ? Math.max(
          Math.min(t.top - d, window.innerHeight - i.realHeight - n.width),
          n.width
        )
      : e === "end"
      ? Math.max(
  ...
  function ie(e, o) {
    ...
    return e === "start"
      ? Math.max(
          Math.min(t.left - d, window.innerWidth - i.realWidth - n.width),
          n.width
        )
      : e === "end"
      ? Math.max(
  ...
  function ne(e, o) {
    const t = l("popover");
    if (!t) return;
    const { align: i = "start", side: d = "left" } =
    ...
    C ? t.arrow.classList.add("driver-popover-arrow-none") : Te(n, _, e);
  }
  function Te(e, o, t) {
    const i = l("popover");
    if (!i) return;
    ...
    function v(a = 0) {
      ...
      const c = p[a],
        ...
        P =
          ...
          s("showButtons"),
        T = ["next", "previous", ...(b ? ["close"] : [])].filter(
