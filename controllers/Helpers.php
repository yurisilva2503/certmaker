...
class Helpers extends Exception
{
    ...
    public static function extrairCampos(array $post, array $esperados): array|false
    {
        ...
        foreach ($esperados as $campo) {
            if (!array_key_exists($campo, $post)) {
                return false; // Campo obrigatório não enviado
            }

            // Permitir valores vazios, mas garantir presença e que seja string
    ...
    public static function extrairCamposSemObrigatoriedade(array $post, array $esperados): array
    {
        ...
        foreach ($esperados as $campo) {
            // Se não existe, insere como vazio
    ...
    public static function validarTelefone($phone): bool
    {
        ...
        // Valida se tem 10 ou 11 dígitos (fixo ou celular no Brasil)
    ...
    {
        $baseURL = 'assets/css'; // URL relativa ao DOCUMENT_ROOT
    ...
    {
        $baseURL = 'assets/js'; // URL relativa ao DOCUMENT_ROOT
    ...
    {
        // Verificação se o caminho é válido
    ...
    public static function getBaseUrlAlt()
    {
        ...
        // Se o script estiver em um subdiretório, inclui o caminho
