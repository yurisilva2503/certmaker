...
try {
    ...
    SimpleRouter::get("/admin/certificados/obter-dados-completos", 'SiteControlador@obterDadosCompletosCertificado');        SimpleRouter::get("/admin/suporte", 'SiteControlador@suporte');
